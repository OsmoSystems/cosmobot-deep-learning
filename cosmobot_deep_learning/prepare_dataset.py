...
def _extract_inputs(df, input_column_names):
    """ Extract non-image input data values
        ...
        Returns:
            A numpy array including just the values of the specified columns
    """
...
def _extract_labels(df, label_column, label_scale_factor_mmhg):
...
def prepare_dataset_numerical(raw_dataset: pd.DataFrame, hyperparameters):
    ...
    x_train_sr = _extract_inputs(train_samples, input_columns)
    y_train_do = _extract_labels(train_samples, label_column, label_scale_factor_mmhg)

    x_test_sr = _extract_inputs(test_samples, input_columns)
    y_test_do = _extract_labels(test_samples, label_column, label_scale_factor_mmhg)
...
#     )
#     y_train_do = _extract_labels(test_samples, label_column, label_scale_factor_mmhg)

#     x_test_sr = _extract_inputs(train_samples, input_columns)
