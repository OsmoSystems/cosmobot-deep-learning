...
def prepare_dataset_numeric(raw_dataset: pd.DataFrame, hyperparameters):
    ...
    training_set_column_name = hyperparameters["training_set_column_name"]
    dev_set_column_name = hyperparameters["dev_set_column_name"]

    train_samples = raw_dataset[raw_dataset[training_set_column_name]]
    test_samples = raw_dataset[raw_dataset[dev_set_column_name]]
